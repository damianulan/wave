...
class CreateAdminUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $root->gender = '1';
        $root->avatar = 'app-assets/images/portrait/small/avatar-male.png';
        $root->locale = 'en';
        $root->save();
        ...
        $user1->nickname = 'Test';
        $user1->gender = '0';
        $user1->avatar = 'app-assets/images/portrait/small/avatar-female.png';
        $user1->locale = 'en';
        $user1->save();
