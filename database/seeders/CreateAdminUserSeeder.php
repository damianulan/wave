...
class CreateAdminUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $root->gender = '1';
        //$root->avatar = 'assets/images/portrait/small/avatar-male.png';
        $root->locale = 'en';
        $root->save();
        ...
        // $admin1->gender = '1';
        // $admin1->avatar = 'assets/images/portrait/small/avatar-male.png';
        // $admin1->locale = 'en';
        // $admin1->save();
        ...
        // $user1->nickname = 'Test';
        // $user1->gender = '0';
        // $user1->avatar = 'assets/images/portrait/small/avatar-female.png';
        // $user1->locale = 'en';
        // $user1->save();
